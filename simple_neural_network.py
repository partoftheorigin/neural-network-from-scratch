...
class NeuralNetwork():
    def __init__(self):
        ...
        # connection. We assign random weights to a 3x1 matrix, with values in
        # range -1 to 1 and mean 0.
        self.synaptic_weights = 2 * random.random((3, 1)) - 1

    def __sigmoid(self, x):
        """The sigmoid function which describes an S shaped curve. We pass the
        weighted sum of inputs through this function to normalize them between
        0 and 1."""
        return 1 / (1 + exp(-x))
    ...
    def think(self, inputs):
        """The neural network thinks. Pass inputs through our neural network
        (our single neuron)"""
    ...
    number_of_training_iterations):
        ...
        for iteration in range(number_of_training_iterations):
            # Pass the training set to our neural network (a single neuron)"""
